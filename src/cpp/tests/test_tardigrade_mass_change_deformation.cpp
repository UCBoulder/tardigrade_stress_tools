...
typedef tardigradeStressTools::massChangeDeformation::secondOrderTensor
    secondOrderTensor;  //!< Redefinition for the second order tensor
typedef tardigradeStressTools::massChangeDeformation::thirdOrderTensor
    thirdOrderTensor;  //!< Redefinition for the third order tensor
typedef tardigradeStressTools::massChangeDeformation::fourthOrderTensor
    fourthOrderTensor;  //!< Redefinition for the fourth order tensor

BOOST_AUTO_TEST_CASE(test_massChangeDeformationBase_constructor, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    floatType dt = 1.2;

    secondOrderTensor At = {1.03834461,  -0.02177823, -0.02781574, 0.00522557, 1.04068676,
                            -0.00783036, 0.04895802,  0.0188219,   1.01639564};
    ...
    tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2> massChange(dt, At, ct, ctp1, rhot,
                                                                                          rhotp1, gammat, parameters,
                                                                                          alpha);
...
BOOST_AUTO_TEST_CASE(test_massChangeDeformationBase_getJA, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    for (unsigned int i = 0; i < 1; i++) {
        ...
        tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2> massChangep(dt, At, ct, ctp1 + delta,
                                                                                               rhot, rhotp1, gammat,
                                                                                               parameters);
        tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2> massChangem(dt, At, ct, ctp1 - delta,
                                                                                               rhot, rhotp1, gammat,
                                                                                               parameters);
    ...
    for (unsigned int i = 0; i < 1; i++) {
        ...
        tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2> massChangep(dt, At, ct, ctp1, rhot,
                                                                                               rhotp1 + delta, gammat,
                                                                                               parameters);
        tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2> massChangem(dt, At, ct, ctp1, rhot,
                                                                                               rhotp1 - delta, gammat,
                                                                                               parameters);
...
BOOST_AUTO_TEST_CASE(test_massChangeDeformationBase_getGammaRHS, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    class massChangeMock : public tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2> {
       public:
        ...
        virtual void setJAt() override { set_JAt(JAt); }

        virtual void setJAtp1() override { set_JAtp1(JAtp1); }

        virtual void setNt() override { set_nt(nt); }

        virtual void setNtp1() override { set_ntp1(ntp1); }
    };
...
BOOST_AUTO_TEST_CASE(test_massChangeDeformationBase_solveGamma, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    class massChangeMock : public tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2> {
       public:
        ...
        virtual void solveGamma_test() { solveGammatp1(); }
    };
...
BOOST_AUTO_TEST_CASE(test_massChangeDeformationBase_computeMassDeformation,
    ...
    class massChangeMock : public tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2> {
       public:
        ...
        virtual void setConvergedGammatp1() override { set_convergedGammatp1(convergedGammatp1); }

        virtual void setdGammatp1dCtp1() override { set_dGammatp1dCtp1(dGammatp1dCtp1); }

        virtual void setdGammatp1dRhotp1() override { set_dGammatp1dCtp1(dGammatp1dRhotp1); }

        virtual void setdGammatp1dNtp1() override { set_dGammatp1dNtp1(dGammatp1dNtp1); }
    };
...
BOOST_AUTO_TEST_CASE(test_massChangeDeformationBase_computeMassDeformation2,
                     *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    class massChangeMock : public tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2> {
       public:
        using tardigradeStressTools::massChangeDeformation::massChangeDeformationBase<2>::massChangeDeformationBase;
...
BOOST_AUTO_TEST_CASE(test_massChangeWeightedDirection_constructor,
                     *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    floatType dt = 1.2;
    ...
    tardigradeStressTools::massChangeDeformation::massChangeWeightedDirection massChange(dt, At, ct, ctp1, rhot, rhotp1,
                                                                                         gammat, vt, vtp1, parameters,
                                                                                         alpha);
...
BOOST_AUTO_TEST_CASE(test_massChangeWeightedDirection_dir, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    for (unsigned int i = 0; i < 3; i++) {
        ...
        tardigradeStressTools::massChangeDeformation::massChangeWeightedDirection massChangep(dt, At, ct, ctp1, rhot,
                                                                                              rhotp1, gammat, vt, vtp1p,
                                                                                              parameters, alpha);

        tardigradeStressTools::massChangeDeformation::massChangeWeightedDirection massChangem(dt, At, ct, ctp1, rhot,
                                                                                              rhotp1, gammat, vt, vtp1m,
                                                                                              parameters, alpha);
...
BOOST_AUTO_TEST_CASE(test_massChangeWeightedDirection_n2, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    class massChangeMock : public tardigradeStressTools::massChangeDeformation::massChangeWeightedDirection {
       ...
       public:
        virtual void setNormvt() override { set_normvt(0); }

        virtual void setDirt() override { set_dirt(dirt); }
...
BOOST_AUTO_TEST_CASE(test_massChangeWeightedDirection_n3, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    class massChangeMock : public tardigradeStressTools::massChangeDeformation::massChangeWeightedDirection {
       ...
       public:
        virtual void setNormvtp1() override { set_normvtp1(0); }
        ...
        virtual void setDirtp1() override { set_dirtp1(dirtp1); }
...
BOOST_AUTO_TEST_CASE(test_massChangeWeightedDirection_dAtp1dVtp1,
                     *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
